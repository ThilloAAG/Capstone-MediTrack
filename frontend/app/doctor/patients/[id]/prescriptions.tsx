      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.wrapper}>
          ...
          <View style={styles.errorContainer}>
            ...
            <Text style={styles.errorText}>This patient is not linked to your doctor account.</Text>
          ...
          <View style={styles.listCard}>
            {loading ? (
              ...
              <View style={styles.empty}>
                ...
                <Text style={styles.emptyText}>Tap the + button to create the first prescription.</Text>
              ...
              items.map((p, idx) => (
                <TouchableOpacity
                  ...
                  onPress={() => {
                    ...
                    router.push(`/doctor/patients/${patientId}/prescriptions/${p.id}`);
                  }}
                >
...
const styles = StyleSheet.create({
  ...
  errorContainer: { flex: 1, alignItems: "center", justifyContent: "center", paddingHorizontal: 16 },
  errorTitle: { marginTop: 16, fontSize: 18, fontWeight: "900", color: "#ef4444" },
  errorText: { marginTop: 8, fontSize: 14, fontWeight: "600", color: "#64748b", textAlign: "center" },
  backBtn: { marginTop: 20, backgroundColor: "#13a4ec", paddingVertical: 12, paddingHorizontal: 24, borderRadius: 14 },
