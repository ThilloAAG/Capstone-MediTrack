    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.wrapper}>
            ...
            {mockMachines.map((machine) => (
              ...
              >
                ...
                <View style={styles.machineImageContainer}>
                  <Image source={{ uri: machine.image }} style={styles.machineImage} resizeMode="cover" />
                </View>
              </TouchableOpacity>
            ))}
          </View>
        ...
        <View style={styles.addButtonContainer}>
          <TouchableOpacity style={styles.addButton} onPress={handleAddMachine} activeOpacity={0.8}>
...
const styles = StyleSheet.create({
  ...
  machineInfo: { flex: 1, gap: 4 },
  machineStatus: { fontSize: 14, fontWeight: "500", color: "#617c89" },
  machineName: { fontSize: 16, fontWeight: "700", color: "#111618" },
  machineLocation: { fontSize: 14, color: "#617c89" },
  machineImageContainer: { width: 96, height: 96, borderRadius: 16, overflow: "hidden" },
  machineImage: { width: "100%", height: "100%" },

  addButtonContainer: { paddingHorizontal: 16, paddingBottom: 16, paddingTop: 16 },
  addButton: {
    flexDirection: "row",
    alignItems: "center",
  ...
  bottomNavigation: {
    ...
    paddingTop: 8,
    paddingBottom: 8,
    paddingHorizontal: 8, // was 16; gives more width per tab
  },
